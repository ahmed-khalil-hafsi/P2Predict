...
### Changed
- Case-study `case-studies/electronic-components/README.md` reproduction recipe now uses `--log-target on` and documents the negative-interval failure mode the flag fixes.
